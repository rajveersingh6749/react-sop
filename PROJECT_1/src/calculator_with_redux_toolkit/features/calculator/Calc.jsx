...
import { back, calculate, clear, addValue } from './calculatorSlice'
...
const Calc = () => {
  ...
  const data = useSelector((state) => state.calculator.data)
      ...
      <div className='calc_container'>
        ...
        <div className='calc'>
          ...
          <div className='buttons'>
            <button onClick={() => dispatch(clear())} className='actions'>
              C
            </button>
            <button onClick={() => dispatch(back())} className='actions'>
              DEL
            </button>
            ...
            <button onClick={() => dispatch(calculate())} className='equals'>
              =
            </button>
          </div>
        </div>
